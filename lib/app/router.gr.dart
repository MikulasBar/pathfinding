...
class PositionConfigRoute extends _i6.PageRouteInfo<void> {
  const PositionConfigRoute({List<_i6.PageRouteInfo>? children})
      : super(
  ...
  static _i6.PageInfo page = _i6.PageInfo(
    name,
    builder: (data) {
      return const _i4.PositionConfigScreen();
    },
  );
}
